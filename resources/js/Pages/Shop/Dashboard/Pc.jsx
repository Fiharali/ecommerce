...
function Pc({ auth, pc }) {
    ...
    const AddPcClothes = (e) => {
        e.preventDefault()
        post(route('add.pc.clothes'))
        data.title = ""
        data.discreption = ""
        data.oldPrice = ""
        data.price = ""
                        ...
                        <section className="home-section " id='idd'>
                            <div className='col-lg-12  col-md-12 '>
                                <div className="row mt-3 subscribe  " id='women'>
                                    <h1 className='h1 text-center  p-2'> Pc Clothes</h1>
                                    <div className="col-lg-5 col-md-12  ">
                                        <form enctype="multipart/form-data" onSubmit={AddPcClothes} className=' subscribe   ' >
                                            <p className='m-2'>form for Pc Clothes</p>
                                                    ...
                                                    pc.map((item) => {
                                                        return (
                                                            <tr key={item.id} className='text-center'>
                                                                ...
                                                                <td onClick={() => { get(route('pc.details', item.id)) }} className=' align-items-center'><i className="fa-solid fa-circle-info fa-2xl" style={{ color: '#151515' }} />
                                                                </td>
                                                            </tr>
                                                        )
                                                    })
