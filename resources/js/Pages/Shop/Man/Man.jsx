...
import './Man.css'
import 'animate.css';
function Man({ auth, man, total,card }) {
                ...
                <div className="row">

                    {
                        man.data.map((item) => {
                            return (
                                <>
                                    <div key={item.id} className=" d-flex justify-content-center col-xl-3 col-lg-4 col-md-6 col-sm-1 pb-1  pt-4" onClick={() => { get(route('man.details', item.id)) }} >
                                        <div className="figure m-3" onClick={() => { get(route('man.details', item.id)) }} >
