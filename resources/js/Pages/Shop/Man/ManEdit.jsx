...
function ManEdit({ auth, man }) {

    const { get, data, setData, post, errors, progress } = useForm({

        title: man.title,
        discreption: man.discreption,
        oldPrice: man.oldPrice,
        price: man.price,
        img1: '',
        img2: '',
        img3: '',
        ...
        <>
            <div className='contt'>
                ...
                <div className=' col-7 mx-auto d-flex justify-content-evenly  '>
                    <img src={`/products/${man.img1}`} alt="" width={100} />
                    <img src={`/products/${man.img2}`} alt="" width={100} />
                    <img src={`/products/${man.img3}`} alt="" width={100} />
                </div>
                <div className="col-lg-4 col-md-8 col-ms-4  mx-auto my-5">
                    <form enctype="multipart/form-data" onSubmit={EditMan} className='py-5  subscribe animate__animated animate__zoomIn text ' >
                        <p className='m-2'>form Edit Women Clothes</p>
                        <div className="mb-1 mt-5">
                            <input type="text" name='title' placeholder={errors.title ? 'This Input Is For "title Man" Required ' : "title Man"} className={`subscribe-input   ${errors.title && 'red'}`}
                        ...
                        <div className="mb-3">
                            <input type="number" name='oldPrice' placeholder={errors.oldPrice ? 'This Input Is For "oldPrice Man" Required  ' : "oldPrice Man"} className={`subscribe-input   ${errors.oldPrice && 'red'}`}
                                value={data.oldPrice} onChange={(e) => setData("oldPrice", e.target.value)} />
                        </div>
                        <div className="mb-3">
                            <input type="number" name='price' placeholder={errors.price ? 'This Input Is For "price Man" Required  ' : "price Man"} className={`subscribe-input   ${errors.price && 'red'}`}
